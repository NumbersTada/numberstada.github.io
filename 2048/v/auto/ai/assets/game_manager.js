function GameManager(size, InputManager, Actuator, StorageManager, AI) {
  ...
  this.inputManager.on("step", this.autoStep.bind(this));
  this.inputManager.on("resetStats", this.ai.resetStats.bind(this.ai));
...
GameManager.prototype.addRandomTile = function (simulate = false) {
...
GameManager.prototype.autoStep = function () {
  this.move(this.ai.getBestMove(this.grid));
}

GameManager.prototype.autoMove = function () {
  this.autoStep();
  if (this.moving) setTimeout(this.autoMove.bind(this),0);
}

GameManager.prototype.startAutoMove = function () {
  this.moving = true;
  this.autoButton.textContent = "Stop AI";
  this.autoMove();
}
GameManager.prototype.stopAutoMove = function () {
  this.moving = false;
  this.autoButton.textContent = "Start AI";
}
