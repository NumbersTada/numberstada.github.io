function GameManager(size, InputManager, Actuator, StorageManager) {
  ...
  this.inputManager.on("xplus", this.xTilesPlus.bind(this));
  this.inputManager.on("xminus", this.xTilesMinus.bind(this));

  this.setup();
}

GameManager.prototype.xTilesPlus = function () {
  this.xTiles += 1;
...
GameManager.prototype.xTilesMinus = function () {
  this.xTiles -= 1;
  if (this.xTiles < 0) this.xTiles = 0;
  else this.restart()
}
// Restart the game
...
GameManager.prototype.addXTiles = function () {
  while (this.grid.cells.flat().filter(obj => obj !== null && obj.value === "x").length < Math.min(16,this.xTiles)){
    if (this.grid.cellsAvailable()) {
